...
<!--                          <th>Node ID</th> item id-->
    ...
    <tbody>
        ...
        <!--                          <td><?php echo $value['node_id'] ?></td>                          -->
                    ...
                    <td><?php echo!empty($value['plate_approve_id']) ? "<a target='_blank' href='".$catlog_url['url']."/plates/" . $value['plate_approve_id'] . "/sbom'>" . $value['plate_txt'] . "" : "---" ?></td>                     
