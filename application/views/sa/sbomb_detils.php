...
<link href="../assets/search_select/selectstyle.css" rel="stylesheet" type="text/css">
    ...
    <input id="sku777_code" class="form-control" type="hidden" name="sku777_code" value="" />
                                                ...
                                                <div  class="col-md-3" aria-hidden="false">
                                                    <label for="mm_code_description" class="control-label">Material description / code</label>
                                                    <input id="mm_code_description" class="form-control" type="text" name="mm_code_description" value=""/>
                                                </div>                                                                                              
                                                <div class="col-sm-2">
                                                    <br/>
...
jQuery(document).ready(function($) {
    ...
    /*mm_code_description*/
    var e = document.getElementById('mm_code_description');
    var mm_code_description = e.value;
    page_num = page_num?page_num:0;
        $.ajax({
        type: 'POST',
        url: "<?php echo base_url().'/sa_epc_sbomb/sbomb_ajax'; ?>/"+page_num,
        data:'page='+page_num+'&sku_code='+sku_code+'&mm_code_description='+mm_code_description,
        beforeSend: function () {
            //start loader 
             $('#loading').show();
        },
...
function e7858xport(){
    ...
    document.location.href = "<?php echo base_url().'sa_epc_sbomb/download_sbometails/'; ?>?sku_code="+sku_code;
                  }
        </script>
