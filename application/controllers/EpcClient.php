...
class EpcClient extends CI_Controller {
    ...
    public function get_dealers() {
        ...
        //$this->nusoap_client = new nusoap_client('http://crtesting.excelloncloud.com/balcrtest/WS/InterfaceWebService.asmx?wsdl', true);
        $client = new nusoap_client('/home/pavaningalkar/Desktop/gladmind/epc/wsdl/InterfaceWebService.WSDL', 'wsdl', $proxyhost, $proxyport, $proxyusername, $proxypassword, 600, 600);
        $err = $client->getError();
        if ($err) {
            /* Constructor error */
            $err .=" \n";
